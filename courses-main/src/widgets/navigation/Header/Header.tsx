        ...
        <div className='flex flex-row items-center gap-2 mr-2'>
            <button onClick={toggleNotifications}>
                <svg width="15"
                 ...
                 <div className={`flex flex-col absolute items-center justify-center gap-y-1 z-10 w-70 h-75 right-3 top-15 shadow-lg rounded-2xl overflow-hidden transition-all duration-150 ${isNotificationActive
            ...
            <div onClick={toggleProfileMenu}>
                ...
                <div className={`flex flex-col absolute items-center justify-center gap-y-1 z-10 w-50 h-25 right-3 top-15 shadow-lg rounded-2xl overflow-hidden transition-all duration-150 ${isActive
                    ...
                    <button className="bg-light-grey shadow-sm cursor-pointer font-Montserrat hover:bg-blue w-40 h-8 rounded-2xl transition duration-150 ease-in-out">Войти</button>
                    <button className=" bg-light-grey shadow-sm cursor-pointer font-Montserrat hover:bg-blue w-40 h-8 rounded-2xl transition duration-150 ease-in-out">Создать аккаунт</button>
                </div>
