...
import { Bell, GraduationCap, LogOut, Settings, User, ChevronDown } from 'lucide-react';
      ...
      <div className="flex flex-row items-center gap-3">
        ...
        <div className="relative flex items-center gap-1.5">
          {isLoading ? (
            ...
            <>
              <Link to={Path.Profile} className="flex h-8 w-8 items-center justify-center rounded-full bg-purple/10 text-xs font-semibold text-purple overflow-hidden">
                {user.avatar_url ? (
